...
exports.isInvalidUsername = function(input) {
    ...
    if (input.length < 4) return 'TOO_SHORT';
...
exports.isInvalidPassword = function(password) {
    ...
    if (password.length < 4) return 'TOO_SHORT';
...
// // TODO: replace HDNode WITH pib32 
// // var node = bitcoinjs.pib32.fromBase58(derivedPubKey);
