...
define([
  ...
  var Anialert = React.createFactory(AnialertClass);
    ...
    var Sound = React.createFactory(SoundClass);
  ...
  this.setState({animation: null });
    ...
    this.setState({takestate: 'nottake'});
      ...
      this.setState(this.getInitialState1(1,4,1));    
      ...
      GameSettingsStore.addChangeListener(this._onChange);
        ...
        if(Engine.username !=null){
            this.setState({ethereumvalue: new_value });
            this._placeBet(bet_amount, pay_amt,profit_amt,new_value);
        } else{ this.setState({ethereumvalue: new_value }); }
  ...
  this.setState({
     ...
     if(ss==='success'){
      ...
      //this.updateGameStatus(game, solution, row, column, '2');
        ...
        console.log(this.state.loading);
          if(this.state.loading === 'true') {
            ...
            var messageContainer; var loginpanel = [];
      ...
      D.a({href:'https://wowkong.wowgo.io'},
                            D.img({ src: 'img/wow-logo.png' , className: 'img-responsive logo-img'}  ),
                            D.img({ src: 'img/wowkong-new.png' , className: 'img-responsive logo-txt'}  )
        )
                        ),
                        ...
                        D.div({className:'col-md-3 col-md-pull-1 headertop-lgbtn'},
      ...
      D.a({href:'https://wowkong.wowgo.io'},
        ...
        D.div({className:''  },                                    
                                ...
                                D.div({ onClick: this.restart , className: (this.state.valid === 'true' ? 'sc-cIShpX play' : 'sc-cIShpX play disabled' ) },
                                   D.span({  },                          
