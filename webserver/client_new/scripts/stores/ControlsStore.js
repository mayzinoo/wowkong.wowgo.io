define([
    ...
    //Bet Size
    var _betSize = Clib.localOrDef('betSize', '0.001');
    ...
    //Profit
    var _profit = Clib.localOrDef('profit', '2.00');
    var profit = Clib.parseprofit(_profit);
    ...
    var ControlsStore = _.extend({}, Events, {
        ...
        _setprofit: function(profit) {
            _profit = profit;
            localStorage['profit'] = _profit;
        },
