...
//--------- API here ------->
     ...
     */
    ScriptExecutor.prototype.placeBet = function(bet, cashOut, new_bet, pay_amt, profit, eth_value, callback) {
        Engine.bet(bet, cashOut, new_bet, pay_amt, profit, eth_value, callback);
    };

     ScriptExecutor.prototype.startgame = function(balance, callback) {
        Engine.reducebalance(balance, callback);
    };
